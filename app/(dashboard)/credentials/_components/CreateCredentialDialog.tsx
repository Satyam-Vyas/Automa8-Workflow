  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogContent className="px-0">
            <CustomDialogHeader icon={ShieldEllipsis}
            ...
            <div className='p-6'>
                <Form {...form}>
                    ...
                    onSubmit={form.handleSubmit(onSubmit)}>
                        ...
                        render={({field}) => (
                            <FormItem>
                                <FormLabel className='flex gap-1 items-center'>
                                    Name
                                    <p className='text-x8 text-primary'>(required)</p>
                                </FormLabel>
                                <FormControl>
                                    <Input {...field} />
                                </FormControl>
                                <FormDescription>
                                    ...
                                    <br />
                                    This name will be used to identify the credential in your workflows.
                                </FormDescription>
                                <FormMessage />
                            </FormItem>
                        )} />
                        ...
                        <Button type="submit" className='w-full' disabled={isPending}>{!isPending && "Proceed" }
