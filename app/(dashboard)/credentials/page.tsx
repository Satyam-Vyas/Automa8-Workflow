    ...
    <div className="p-4 flex flex-1 flex-col h-full">
        ...
        <div className="h-full py-6 space-y-8">
            <Alert>
                ...
                <AlertDescription>
                    All information is securely encrypted and stored in our database. 
                    We use the latest encryption standards to ensure your data is safe.
                </AlertDescription>
            </Alert>
            ...
            return (
                <Card key={credential.id} className='w-full p-4 flex justify-between'>
                    <div className='flex gap-2 items-center'>
                        <div className="rounded-full bg-primary/10 w-8 h-8 flex items-center
                        justify-center">
