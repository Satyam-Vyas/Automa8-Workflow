...
import { ExecutionPhaseStatus, WorkflowExecutionStatus } from "@/types/workflowTypes";
...
export default function ExecutionViewer({
  ...
  useEffect(() => {
    ...
    const phaseToSelect = phases.toSorted((a, b) => 
      a.completedAt! > b.completedAt! ? -1 : 1)[0];
    setSelectedPhase(phaseToSelect.id);
  ...
  return (
    <div className="flex w-full h-full">
      ...
      border-r-2 border-separate flex flex-col flex-grow overflow-hidden"
      >
        ...
        <div className="flex justify-center items-center py-2 px-4">
          <div className="text-muted-foreground flex items-center py-2 px-4">
...
function LogViewer({ logs }: { logs: ExecutionLog[] | undefined }) {
  ...
  return (
    <Card className="w-full">
      <CardHeader
        className="rounded-lg rounded-b-none border-b py-4 bg-gray-50 
      dark:bg-background"
      >
